...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,375 | 🐛 18 | 📅 2026-09-13.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,502 | 🐛 189 | 🌐 Java | 📅 2026-09-20 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,838 | 🐛 244 | 🌐 TypeScript | 📅 2026-09-19 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 96,406 | 🐛 219 | 🌐 TypeScript | 📅 2026-09-20 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,596 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-20 - Headless Google Chrome Node API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,769 | 🐛 201 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [ResembleJS](https://github.com/Huddle/Resemble.js) ⭐ 4,609 | 🐛 29 | 🌐 JavaScript | 📅 2024-02-06 - Analyse and compare images with Javascript and HTML5.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,911 | 🐛 37 | 🌐 Java | 📅 2026-09-19 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,502 | 🐛 189 | 🌐 Java | 📅 2026-09-20.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,596 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-20.
...
* [Touca](https://github.com/trytouca/trytouca) ⭐ 509 | 🐛 6 | 🌐 TypeScript | 📅 2024-08-04 - Open source continuous regression testing without the hassle of managing snapshot files.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 419 | 🐛 26 | 🌐 Rust | 📅 2026-09-20 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,596 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-20.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,502 | 🐛 189 | 🌐 Java | 📅 2026-09-20.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 714 | 🐛 55 | 🌐 Shell | 📅 2026-09-01 - Open Source selfhosted service for visual regression testing
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-20 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,502 | 🐛 189 | 🌐 Java | 📅 2026-09-20.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,502 | 🐛 189 | 🌐 Java | 📅 2026-09-20 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,838 | 🐛 244 | 🌐 TypeScript | 📅 2026-09-19 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,502 | 🐛 189 | 🌐 Java | 📅 2026-09-20.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,414 | 🐛 19 | 📅 2026-05-27.
