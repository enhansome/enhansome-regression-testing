...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,363 | 🐛 7 | 📅 2026-08-30.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,441 | 🐛 191 | 🌐 Java | 📅 2026-09-01 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,832 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-31 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,534 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-31 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,475 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-01 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,413 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,441 | 🐛 191 | 🌐 Java | 📅 2026-09-01.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,534 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-31.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 420 | 🐛 27 | 🌐 Rust | 📅 2026-09-01 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,534 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-31.
...
* [Lastest](https://github.com/las-team/lastest) ⭐ 18 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 - Visual regression testing platform built on Playwright with screenshot diffing, baseline review, and AI flake triage. Self-hostable via docker-compose or k8s.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,441 | 🐛 191 | 🌐 Java | 📅 2026-09-01.
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 151 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-01 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.

* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,441 | 🐛 191 | 🌐 Java | 📅 2026-09-01.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,441 | 🐛 191 | 🌐 Java | 📅 2026-09-01 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
* [dpxdt](https://github.com/bslatkin/dpxdt) ⭐ 1,437 | 🐛 29 | 🌐 Python | 📅 2016-12-05 - End-to-end testing with Python.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,832 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-31 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,441 | 🐛 191 | 🌐 Java | 📅 2026-09-01.
