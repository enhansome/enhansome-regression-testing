...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,379 | 🐛 20 | 📅 2026-09-13.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,509 | 🐛 189 | 🌐 Java | 📅 2026-09-22 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,840 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-22 - Node.js bindings implementation for the W3C WebDriver protocol.
* [SlimerJS](https://github.com/laurentj/slimerjs) ⭐ 2,997 | 🐛 164 | 🌐 JavaScript | 📅 2023-03-09 - Scriptable browser like PhantomJS, based on Firefox.
* [Cypress.io](https://www.cypress.io/) - An automation framework that runs in-browser.

## Tools and frameworks (a-z↓)

* [Playwright](https://github.com/microsoft/playwright) ⭐ 96,504 | 🐛 214 | 🌐 TypeScript | 📅 2026-09-22 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,609 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-21 - Headless Google Chrome Node API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,240 | 🐛 198 | 🌐 JavaScript | 📅 2026-09-22 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,915 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-05 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,911 | 🐛 37 | 🌐 Java | 📅 2026-09-21 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
* [Loki](https://github.com/oblador/loki) ⭐ 1,909 | 🐛 141 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,509 | 🐛 189 | 🌐 Java | 📅 2026-09-22.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,295 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-15 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,609 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-21.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 419 | 🐛 26 | 🌐 Rust | 📅 2026-09-22 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,609 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-21.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,509 | 🐛 189 | 🌐 Java | 📅 2026-09-22.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 716 | 🐛 55 | 🌐 Shell | 📅 2026-09-01 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 152 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-18 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.

* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-22 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,509 | 🐛 189 | 🌐 Java | 📅 2026-09-22.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,509 | 🐛 189 | 🌐 Java | 📅 2026-09-22 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,840 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-22 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,509 | 🐛 189 | 🌐 Java | 📅 2026-09-22.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,415 | 🐛 19 | 📅 2026-05-27.
