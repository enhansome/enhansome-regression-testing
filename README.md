...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,371 | 🐛 14 | 📅 2026-09-04.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,481 | 🐛 186 | 🌐 Java | 📅 2026-09-09 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,837 | 🐛 295 | 🌐 TypeScript | 📅 2026-09-07 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,861 | 🐛 165 | 🌐 TypeScript | 📅 2026-09-09 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09 - Headless Google Chrome Node API.
...
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,955 | 🐛 334 | 🌐 JavaScript | 📅 2026-05-25 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,904 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-08 - Automated browser testing for the modern web development stack.
* [Protractor](https://github.com/angular/protractor) ⚠️ Archived - E2E test framework for Angular apps.
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,179 | 🐛 578 | 🌐 JavaScript | 📅 2026-09-08 - Config-driven automated screenshot test framework.
* [ResembleJS](https://github.com/Huddle/Resemble.js) ⭐ 4,611 | 🐛 29 | 🌐 JavaScript | 📅 2024-02-06 - Analyse and compare images with Javascript and HTML5.
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,242 | 🐛 210 | 🌐 JavaScript | 📅 2026-09-09 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Loki](https://github.com/oblador/loki) ⭐ 1,910 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,910 | 🐛 33 | 🌐 Java | 📅 2026-09-08 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,414 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,481 | 🐛 186 | 🌐 Java | 📅 2026-09-09.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,292 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-07 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09.
...
* [CSSCritic](https://github.com/cburgmer/csscritic) ⭐ 488 | 🐛 17 | 🌐 JavaScript | 📅 2023-01-28 - Lightweight CSS regression testing.
...
* [Creevey](https://github.com/wKich/creevey) ⭐ 433 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-06 - Cross-browser visual testing with magic. Feature-rich tool with UI Runner, Tests Hot Reloading, Docker and Storybook integration.
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 419 | 🐛 23 | 🌐 Rust | 📅 2026-09-09 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,558 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-09.
...
* [Lastest](https://github.com/las-team/lastest) ⭐ 18 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-09 - Visual regression testing platform built on Playwright with screenshot diffing, baseline review, and AI flake triage. Self-hostable via docker-compose or k8s.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,481 | 🐛 186 | 🌐 Java | 📅 2026-09-09.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 711 | 🐛 55 | 🌐 Shell | 📅 2026-09-01 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 152 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.

* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,481 | 🐛 186 | 🌐 Java | 📅 2026-09-09.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,481 | 🐛 186 | 🌐 Java | 📅 2026-09-09 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,837 | 🐛 295 | 🌐 TypeScript | 📅 2026-09-07 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,481 | 🐛 186 | 🌐 Java | 📅 2026-09-09.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,412 | 🐛 18 | 📅 2026-05-27.
