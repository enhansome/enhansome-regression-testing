...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,365 | 🐛 7 | 📅 2026-09-04.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,464 | 🐛 192 | 🌐 Java | 📅 2026-09-04 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,834 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-04 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,627 | 🐛 187 | 🌐 TypeScript | 📅 2026-09-04 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,542 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-04 - Headless Google Chrome Node API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,242 | 🐛 220 | 🌐 JavaScript | 📅 2026-09-03 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Loki](https://github.com/oblador/loki) ⭐ 1,909 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,413 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,464 | 🐛 192 | 🌐 Java | 📅 2026-09-04.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,542 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-04.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 420 | 🐛 27 | 🌐 Rust | 📅 2026-09-04 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,542 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-04.
...
* [Lastest](https://github.com/las-team/lastest) ⭐ 18 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-04 - Visual regression testing platform built on Playwright with screenshot diffing, baseline review, and AI flake triage. Self-hostable via docker-compose or k8s.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,464 | 🐛 192 | 🌐 Java | 📅 2026-09-04.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 709 | 🐛 55 | 🌐 Shell | 📅 2026-09-01 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 151 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-03 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.

* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,464 | 🐛 192 | 🌐 Java | 📅 2026-09-04.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,464 | 🐛 192 | 🌐 Java | 📅 2026-09-04 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,834 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-04 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,464 | 🐛 192 | 🌐 Java | 📅 2026-09-04.
