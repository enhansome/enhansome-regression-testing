...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,366 | 🐛 187 | 🌐 Java | 📅 2026-08-13 - Browser automation framework and ecosystem.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,459 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-12 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,443 | 🐛 150 | 🌐 TypeScript | 📅 2026-08-13 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,780 | 🐛 202 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,167 | 🐛 577 | 🌐 JavaScript | 📅 2024-09-07 - Config-driven automated screenshot test framework.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,908 | 🐛 35 | 🌐 Java | 📅 2026-08-12 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,414 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,366 | 🐛 187 | 🌐 Java | 📅 2026-08-13.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,459 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-12.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 418 | 🐛 27 | 🌐 Rust | 📅 2026-08-12 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,459 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-12.
...
* [Lastest](https://github.com/las-team/lastest) ⭐ 12 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-12 - Visual regression testing platform built on Playwright with screenshot diffing, baseline review, and AI flake triage. Self-hostable via docker-compose or k8s.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,366 | 🐛 187 | 🌐 Java | 📅 2026-08-13.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-12 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,366 | 🐛 187 | 🌐 Java | 📅 2026-08-13.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,366 | 🐛 187 | 🌐 Java | 📅 2026-08-13 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,816 | 🐛 355 | 🌐 TypeScript | 📅 2026-08-12 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,366 | 🐛 187 | 🌐 Java | 📅 2026-08-13.
