...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,363 | 🐛 8 | 📅 2026-08-28.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,829 | 🐛 291 | 🌐 TypeScript | 📅 2026-08-29 - Node.js bindings implementation for the W3C WebDriver protocol.
* [SlimerJS](https://github.com/laurentj/slimerjs) ⭐ 2,998 | 🐛 164 | 🌐 JavaScript | 📅 2023-03-09 - Scriptable browser like PhantomJS, based on Firefox.
* [Cypress.io](https://www.cypress.io/) - An automation framework that runs in-browser.

## Tools and frameworks (a-z↓)

* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,528 | 🐛 267 | 🌐 TypeScript | 📅 2026-08-30 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,377 | 🐛 176 | 🌐 TypeScript | 📅 2026-08-29 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,771 | 🐛 202 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,957 | 🐛 334 | 🌐 JavaScript | 📅 2026-05-25 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,177 | 🐛 578 | 🌐 JavaScript | 📅 2024-09-07 - Config-driven automated screenshot test framework.
* [ResembleJS](https://github.com/Huddle/Resemble.js) ⭐ 4,613 | 🐛 29 | 🌐 JavaScript | 📅 2024-02-06 - Analyse and compare images with Javascript and HTML5.
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,242 | 🐛 220 | 🌐 JavaScript | 📅 2026-08-30 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,914 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-05 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,909 | 🐛 31 | 🌐 Java | 📅 2026-08-29 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
* [Loki](https://github.com/oblador/loki) ⭐ 1,908 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,413 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,287 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-26 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
* [Chimp](https://github.com/xolvio/chimp) ⭐ 800 | 🐛 9 | 🌐 TypeScript | 📅 2023-11-10 - Develop acceptance tests & end-to-end tests with realtime feedback.
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,528 | 🐛 267 | 🌐 TypeScript | 📅 2026-08-30.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 418 | 🐛 27 | 🌐 Rust | 📅 2026-08-30 - Visual regression test tool which output easy-to-read single file html report.
...
* [AyeSpy](https://github.com/newsuk/ayespy) ⭐ 221 | 🐛 43 | 🌐 JavaScript | 📅 2025-10-06 - 44 image comparisons in 90 seconds.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,528 | 🐛 267 | 🌐 TypeScript | 📅 2026-08-30.
...
* [Lastest](https://github.com/las-team/lastest) ⭐ 18 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-30 - Visual regression testing platform built on Playwright with screenshot diffing, baseline review, and AI flake triage. Self-hostable via docker-compose or k8s.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 709 | 🐛 55 | 🌐 Shell | 📅 2026-08-23 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 151 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-28 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.

* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-28 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [trifleJS](https://github.com/sdesalas/trifleJS) ⭐ 827 | 🐛 19 | 🌐 JavaScript | 📅 2026-04-27 - Headless automation for Internet Explorer. (last update 2016)
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,829 | 🐛 291 | 🌐 TypeScript | 📅 2026-08-29 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,414 | 🐛 17 | 📅 2026-05-27.
