...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,372 | 🐛 14 | 📅 2026-09-13.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,491 | 🐛 190 | 🌐 Java | 📅 2026-09-15 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,834 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-15 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 96,164 | 🐛 186 | 🌐 TypeScript | 📅 2026-09-14 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,581 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-15 - Headless Google Chrome Node API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,768 | 🐛 201 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,180 | 🐛 579 | 🌐 JavaScript | 📅 2026-09-08 - Config-driven automated screenshot test framework.
...
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,915 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-05 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,491 | 🐛 190 | 🌐 Java | 📅 2026-09-15.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,293 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-15 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 638 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,581 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-15.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 419 | 🐛 24 | 🌐 Rust | 📅 2026-09-15 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,581 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-15.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,491 | 🐛 190 | 🌐 Java | 📅 2026-09-15.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-15 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,491 | 🐛 190 | 🌐 Java | 📅 2026-09-15.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,491 | 🐛 190 | 🌐 Java | 📅 2026-09-15 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,834 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-15 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,491 | 🐛 190 | 🌐 Java | 📅 2026-09-15.
